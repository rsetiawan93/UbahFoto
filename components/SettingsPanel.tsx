...
const SettingsPanel: React.FC<SettingsPanelProps> = ({ activeMenu, onGenerate, onCrop, isLoading }) => {
  ...
  return (
    <main className="w-full md:w-[30%] flex-shrink-0 bg-gray-800/50 p-8 overflow-y-auto h-full">
      <div className="max-w-2xl mx-auto">
        <header className="mb-8">
          <h2 className="text-3xl font-bold text-white">{activeMenuItem?.label}</h2>
          <p className="text-gray-400 mt-1">{activeMenuItem?.description}</p>
        </header>
        
        <div id="tutorial-upload" className="bg-gray-900/50 p-6 rounded-xl border border-gray-700">
